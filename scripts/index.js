  ...
  let EntryComponent = _decorate([customElement('entry-component')], function (_initialize, _LitElement) {
    ...
    return {
      ...
      d: [{
        ...
        kind: "method",
        key: "_getBranchVersion",
        value: function _getBranchVersion(branch) {
        ...
        kind: "method",
        key: "_sortBranches",
        value: function _sortBranches(branches) {
          branches.sort((a, b) => {
        ...
        kind: "method",
        key: "_findLocatedPullPath",
        value: function _findLocatedPullPath(branchFiles, pull) {
          const topLevel = branchFiles[""] || [];
          if (!pull.files) {
            return "";
          }
        ...
        kind: "method",
        key: "_locatePullInUi",
        value: function _locatePullInUi(pullNumber, pull) {
          const branchFiles = typeof this._files[pull.target_branch] === "undefined" ? null : this._files[pull.target_branch];
          if (branchFiles === null) {
            return;
          }
